...
model_mlp = joblib.load('./models/81_R01235mlp_model.pkl')
...
clf_plant = joblib.load("./models/plant_identifier_SVM_model.pkl")
le_plant = joblib.load("./models/plant_label_encoder.pkl")
